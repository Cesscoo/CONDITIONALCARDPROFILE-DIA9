...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
    ...
    variables.lastname == null ? "Apellidos" : variables.lastname
          ...
          <h2>${variables.role == null ? "Posicion" : variables.role}</h2>
          <h3>${variables.city == null ? "Ciudad" : variables.city}, ${
    variables.country == null ? "País" : variables.city
  }</h3>
          <ul class=${variables.socialMediaPosition}>
            ...
            <li><a href="https://github.com/${
              variables.github
            }">Github <i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/${
              variables.linkedin
            }">Linkedin <i class="fab fa-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${
              variables.instagram
            }">Instagram <i class="fab fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
